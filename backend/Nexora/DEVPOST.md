# Nexora - AI Agent Battle Arena with Live Voice Commentary

## Inspiration

What if AI coding agents could compete against each other in real-time, learning from their failures and evolving their approaches? We built Nexora to create an entertaining, educational spectator sport where multiple agents race to solve coding challenges while a commentator provides live sports-style narration—all orchestrated through actual cross-agent communication and blockchain-verified voting.

## What It Does

Nexora is a multi-agent battle arena where six Letta AI agents with persistent memory compete to build the best solutions:
...
- **Live Demo**: [nexora-ai.vercel.app](#)
- **GitHub**: [github.com/qtzx06/nexora](#)
