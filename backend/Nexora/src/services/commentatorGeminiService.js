...
Keep it simple and natural - you're just reporting what's happening with agent names.`;
  ...
  getWelcomeIntro(query) {
    ...
    const intros = [
      `Welcome everyone to Nexora! Today's challenge: ${query}. Let's see what these agents got!`,
      ...
      `Welcome to Nexora! ${query} is the mission. Let's see which agent brings the heat today!`
    ];
