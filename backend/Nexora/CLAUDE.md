...
Nexora is a React + Vite application featuring a multi-agent AI coding battle system. The landing page includes advanced visual effects with FBO particle animations, liquid glass morphism, and interactive elements. The main orchestration page showcases 4 AI agents (Speedrunner, Bloom, Solver, Loader) competing to build React components based on user prompts, with live voice commentary.
...
- Footer with links to GitHub (https://github.com/qtzx06/nexora) and Devpost (https://devpost.com/software/nexora-w6fez0)
...
2. Orchestration page → Click "NEXORA //" header to return to landing page
